...
from src.rag.indexing import SUPPORTED_FILE_EXTENSIONS, is_supported_file_extension
from src.rag.utils import calculate_content_hash
from src.graphrag.graph_builder import load_entity_graph, graph_summary
...
async def add_documents(
    ...
    if content_type == "file":
        from src.rag.utils.kb_utils import validate_file_path
